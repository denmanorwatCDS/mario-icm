...
class A2C(OnPolicyAlgorithm):
    ...
    def __init__(
        ...
        super().__init__(
            policy,
            env,
            motivation_buffer=motivation_buffer,
            forward_backward_motivation=forward_backward_motivation,
    ...
    def train_motivation(self):
        observations, actions, next_observations = self.motivation_buffer.get_triplets()
        # print(observations.shape)
        predicted_actions, predicted_states, next_states =\
            self.forward_backward_motivation.forward(observations, actions, next_observations)
