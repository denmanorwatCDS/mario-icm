...
class EgocentricAntMazeEnv(MazeEnv, EzPickle):
    """
    ### Description
    ...
    def __init__(
        ...
        **kwargs,
        ...
        ant_xml_file_path = path.join(
            path.dirname(path.realpath(__file__)), "/home/dvasilev/doom_icm/mario_icm/MuJoCo_custom/AntMuJoCo.xml"
        )
        super().__init__(
        ...
        # Custom
        self.ant_env.camera_name = "egocentric"
