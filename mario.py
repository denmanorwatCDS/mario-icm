...
def atari_wrapper(env, icm=None, icm_optimizer=None, icm_buffer=None, clip_reward = True):
    """
...
if __name__=="__main__":
    ...
    env = make_vec_env("SuperMarioBros-v0", n_envs=parallel_envs, seed=0, 
                       ...
                       wrapper_kwargs={"icm": icm, "icm_optimizer": icm_optimizer, "icm_buffer": icm_buffer})
